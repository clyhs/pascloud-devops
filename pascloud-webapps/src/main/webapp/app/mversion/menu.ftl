...
<head>
    ...
    <script type="text/javascript" src="/app/mversion/js/menuTenantTreeDialog.js"></script>
    <script type="text/javascript" src="/app/mversion/js/menuTreeRestoreDialog.js"></script>
