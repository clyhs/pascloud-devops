...
<body id="main" class="easyui-layout">
	...
	<div class="easyui-layout" data-options="fit:true">-->
		...
		<div id="mainCenter" class="easyui-tabs" data-options="region:'center'" >
		    <!--内容  开始-->
		    <div id="mainGridLayout" class="easyui-layout" data-options="title:'首页',iconCls:'icon-house',fit:true" >
